namespace Fluke.UI.Electron.Main
...
module Main =
    ...
    let createMainWindow () =
        ...
        win.webContents.onceDevtoolsFocused (fun _ -> JS.setTimeout win.webContents.focus 1 |> ignore)
        |> ignore
...
//#endif
        ...
        win.onClosed (fun _ -> mainWindow <- None)
        |> ignore
    ...
    main.app.onReady (fun _ _ -> createMainWindow ())
    |> ignore
