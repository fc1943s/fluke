...
//        ]
            Navbar.navbar [ Navbar.Color IsBlack ] [
                ...
                let checkbox isChecked text onClick =
                    Bulma.navbarItem.div [ prop.className "field"
                                           prop.onClick (fun _ -> onClick ())
                                           prop.style [ style.marginBottom 0
                                                        style.alignSelf.center ]
                                           prop.children [ Checkbox.input [ CustomClass "switch is-small is-dark"
                ...
                Bulma.navbarItem.div
                    [ activeSessions
                      |> List.map (fun (ActiveSession (taskName, duration)) ->
                          ...
                          Html.span [ prop.style [ style.color color ]
                                      prop.children
                                          [ sprintf
    ...
    let render =
        React.memo (fun (input: {| Attachments: Attachment list |}) ->
            ...
            | _ ->
                ...
                Html.div [ prop.ref tooltipContainerRef
                           prop.classes [ Css.tooltipContainer
                                          match user with
                                          | { Color = UserColor.Blue } -> Css.topRightBlueIndicator
                                          | { Color = UserColor.Pink } -> Css.topRightPinkIndicator ]
                           prop.children
                               [ Html.div [ prop.className Css.tooltipPopup
                                            prop.children
                                                [ comments
...
module PanelsComponent =
    ...
    module LanesPanel =
        ...
        module HeaderComponent =
            ...
            module DayComponent =
                let render =
                    React.memo (fun (input: {| Date: FlukeDate; Label: string |}) ->
                        ...
                        Html.span [ prop.classes [ Css.cellSquare
                                                   ...
                                                   | _ -> () ]
                                    prop.children [ input.Label |> String.toLower |> str ] ])
            ...
            let render =
                React.memo (fun () ->
                    ...
                    Html.div [ Html.div [ prop.style [ style.display.flex ]
                                          prop.children
                                              [ yield! datesByMonth
                                                       |> List.map (fun dates ->
                                                           let firstDate =
                                                           ...
                                                           Html.span [ prop.style [ style.textAlign.center
                                                                                    style.width cellWidth ]
                                                                       prop.children [ str month ] ]) ] ]
        ...
        module TaskNameComponent =
            ...
            let render =
                React.memo (fun (input: {| Level: int; TaskId: TaskId |}) ->
                    ...
                    let taskAttachments =
                        ...
                        |> List.choose (fun (UserInteraction (user, moment, interaction)) ->
                            ...
                            | Interaction.Task (task, taskInteraction) ->
                                ...
                                | TaskInteraction.Attachment attachment -> Some attachment
                                | _ -> None
                            | _ -> None)

                    Html.div [ prop.ref ref
                               prop.classes [ classes.root
                                              Css.cellRectangle ]
                               prop.children [ Html.div [ prop.classes [ classes.name
                                                                         if hasSelection then Css.selectionHighlight ]
                                                          prop.style [ yield! paddingLeftLevel input.Level ]
                                                          prop.children [ str taskName ] ]
                                               TooltipPopupComponent.render {| Attachments = taskAttachments |} ] ])

        module UserStatusIndicatorComponent =
            let render =
                React.memo (fun (input: {| User: User |}) ->
                    Html.div
                        [ prop.classes [ Css.userIndicator
        ...
        module CellSessionIndicatorComponent =
            let render =
                React.memo (fun (input: {| Sessions: TaskSession list |}) ->
                    Html.div [ prop.classes [ Css.cellSquare
        ...
        module CellComponent =
            ...
            let render =
                React.memo (fun (input: {| TaskId: TaskId; Date: FlukeDate |}) ->
                    let cellId =
        ...
        module CellsComponent =
            let render =
                React.memo (fun (input: {| TaskIdList: TaskId list |}) ->
                    Recoil.Profiling.addTimestamp "cells.render"

                    let dateSequence =
                        Recoil.useValue Recoil.Selectors.dateSequence

                    Html.div [ prop.className Css.laneContainer
                               prop.children
        ...
        module CalendarViewComponent =
            let render =
                React.memo (fun () ->
                    ...
                    Html.div [ prop.className Css.lanesPanel
                               prop.children [ Html.div [ yield! Html.div [ prop.className Css.cellRectangle ]
                                                                 |> List.replicate 3

                                                          Html.div [ prop.style [ style.display.flex ]
                                                                     prop.children [ Html.div [ prop.style
                                                                                                    [ style.paddingRight
                                                                                                        10 ]
                                                                                                prop.children
                                                                                                    [ yield! currentTaskList
                                                                                                             |> List.map (fun task ->
                                                                                                                 Html.div [ prop.className
                                                                                                                                Css.cellRectangle
                                                                                                                            prop.children [ Html.div [ prop.style [ style.color
                                                                                                                                                                        task.Information.Color
                                                                                                                                                                    style.whitespace.nowrap ]
                                                                                                                                                       prop.children
                                                                                                                                                           [ str
                                                                                                             ...
                                                                                                             |> List.map (fun task ->
                                                                                                                 TaskNameComponent.render
                                                                                                                     {| Level =
                                                                                                                        ...
                                                                                                                        TaskId =
                                                                                                                            task.Id |}) ] ] ] ] ]
                                               Html.div [ HeaderComponent.render ()
                                                                                      ...
                                                                                      Html.div
                                                                                          [ yield! taskGroups
                                                                                                   |> List.map (fun (information, group) ->
                                                                                                       let informationInteractions =
                                                                                                           groupMap.[information].InformationInteractions

                                                                                                       Html.div [ Html.div [ prop.className
                                                                                                                                 Css.cellRectangle
                                                                                                                             prop.children [ Html.div [ prop.style [ style.color
                                                                                                                                                                         "#444"
                                                                                                                                                                     yield! paddingLeftLevel
                                                                                                                                                                                1 ]
                                                                                                                                                        prop.children
                                                                                                                                                            [ str
                                                                                                                                                                information.Name ] ]
                                                                                                                                                ...
                                                                                                                                                {| Attachments =
                                                                                                                                                       ...
                                                                                                                                                       |> List.choose (function
                                                                                                                                                           ...
                                                                                                                                                           | _ ->
                                                                                                                                                               None) |} ] ]) ] ]
                                                                                     // Column: Priority
                                                                                     Html.div [ prop.style [ style.paddingRight
                                                                                                                 10
        ...
        module WeekViewComponent =
            let render =
                React.memo (fun () ->
                    ...
                    Html.div [ prop.className Css.lanesPanel
                               prop.style [ style.custom ("width", "300%")
                                            style.display.block ]
                               prop.children
                                   [ yield! weekCellsMap
                                            |> List.map (fun week ->
                                                           ...
                                                           prop.children
                                                               [ yield! week
                                                                        ...
                                                                        |> Seq.map (fun dateId ->
                                                                            ...
                                                                            Html.div [ prop.style [ style.paddingLeft 10
                                                                                                    style.paddingRight
                                                                                                        10
                                                                                                    style.custom
                                                                                                        ("width", "100%") ]
                                                                                       prop.children [ Html.div [ prop.classes
                                                                                                                      [ if cells
                                                                                                                           |> List.forall (fun x ->
                                                                                                                               x.IsToday) then
                                                                                                                          Css.todayHeader ]
                                                                                                                  prop.style [ style.marginBottom
                                                                                                                                   3
                                                                                                                               style.borderBottom
                                                                                                                                   (length.px
                                                                                                                                       1,
                                                                                                       ...
                                                                                                       yield! cells
                                                                                                              |> List.map (fun cell ->
                                                                                                                  Html.div [ prop.style
                                                                                                                                 [ style.display.flex ]
                                                                                                                             prop.children [ CellComponent.render
                                                                                                                                                 {| Date =
                                                                                                                                                        dateId
                                                                                                                                                        |> ofDateId
                                                                                                                                                    TaskId =
        ...
        module DetailsComponent =
            let render =
                React.memo (fun () ->
                    ...
                    Html.div [ prop.className Css.detailsPanel
                               prop.children [ str "Details" ] ])
    ...
    let render =
        React.memo (fun () ->
            ...
            Html.div [ prop.className Css.panels
                       prop.children [ match view with
            ...
            React.useEffect
                ((fun () ->
                    ...
                    |> List.map (fun (Model.ActiveSession (oldTaskName, oldDuration)) ->
                        ...
                        | Some (Model.ActiveSession (_, newDuration)) when oldDuration = -1. && newDuration = 0. ->
                            Temp.Sound.playTick
                        | Some (Model.ActiveSession (_, newDuration)) when newDuration = TempData.Consts.sessionLength ->
                            Temp.Sound.playDing
    ...
    let diag =
        React.memo (fun () ->
            ...
            if not debug then
                ...
                React.fragment [ Html.pre [ prop.id "diag"
                                            prop.style [ style.custom ("width", "min-content")
